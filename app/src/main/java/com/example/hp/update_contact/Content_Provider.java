...
public class Content_Provider {
    ...
    public static int updateContact(ContentResolver contactUpdate, String name, String mobileNumber)
        ...
        String where = ContactsContract.Data.RAW_CONTACT_ID + " = ? AND mimetype_id=5 AND  "
        ...
        ContentProviderResult[] contentProviderResult = contactUpdate.applyBatch
    ...
    private static String getRawContactID(ContentResolver contentResolver,String name) {
