package com.example.hp.update_contact;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /*
         The request code used in ActivityCompat.requestPermissions() and
    ...
    private void updateContact() {
        ...
        /*
         Inflate and set the layout for the dialoge Pass null as the parent view because
        ...
        builder.setView(view)
                ...
                .setPositiveButton(R.string.save_contact, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int id) {
                        ...
                        int saveStatus = 0;
                        try {
                            saveStatus = Content_Provider.updateContact(getContentResolver(),
    ...
    private void insertContact() {
        AlertDialog.Builder builder = new AlertDialog.Builder(this);
        // Creating object of LayoutInflater
        LayoutInflater inflater = getLayoutInflater();
        ...
        builder.setView(view)
                ...
                .setPositiveButton(R.string.save_contact, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int id) {
                        ...
                        boolean saveStatus = Content_Provider.insertContact(getContentResolver(),
                                contactName, contactPhone);
        ...
        switch (requestCode) {
            case PERMISSION_ALL : {
                ...
                if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED)
                {
                    ...
                    /*
                    Permission was granted and execute the contacts-related task.
